...
public class InsertWellnessDataServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    if (loggedInUser != null) {
		        ...
		        if (validateInput(metricName, value)) {
		            try {
		            ...
		            response.sendRedirect(request.getContextPath() + "/insertWellnessData.jsp?error=invalidValue");
		        }
		    } else {
		...
		private boolean validateInput(String metricName, String value) {
		    if ("sleep".equals(metricName)  || "stress".equals(metricName)) {
		        try {
		    ...
		    else if ("mood".equals(metricName) || "nutrition".equals(metricName)|| "food".equals(metricName))
		    {
		    	try {
